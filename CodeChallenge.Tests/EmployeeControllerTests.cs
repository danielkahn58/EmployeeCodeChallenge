    ...
    public class EmployeeControllerTests
    {
        ...
        public void CreateCompensation_Returns_Created()
        {
            ...
            var compensation = new Compensation()
            {
                ...
                Salary = 45000,
                EffectiveDate = DateTime.ParseExact("5/01/2009 09:00", "M/dd/yyyy hh:mm", new CultureInfo("en-US"), DateTimeStyles.None),
            };
        ...
        public void GetCompensationByEmployeeId_Returns_Ok()
        {
            ...
            var expectedFirstName = "John";
            var expectedLastName = "Lennon";
            var expectedSalary = 45000;
            var ExpectedEffectiveDate = DateTime.ParseExact("5/01/2009 09:00", "M/dd/yyyy hh:mm", new CultureInfo("en-US"), DateTimeStyles.None);

            // Execute
            var getRequestTask = _httpClient.GetAsync($"api/compensation/byemployeeid/{EmployeeId}");
            var response = getRequestTask.Result;
